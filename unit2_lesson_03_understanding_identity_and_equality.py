...
-diff btwn is and ==
-why small numbers behave differently--- (-5 to 256) is kept in an array.so when u use them actually it create a reference but 
    not a new number 
- None keyword is builtin constant
"""
