...
-empty list,string,tuple,set,dict and Nonetype gives 0 in if statement i.e.,if checks whether value is present or not
-But these empty data structers doenot mean they are equal to false or true for non empty ds.
-0==False 1==True only have equality (2==True gives false )
"""
