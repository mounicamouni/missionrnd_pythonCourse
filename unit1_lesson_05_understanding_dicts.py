...
def test_valid_dictionary_keys():
    ...
    try:
        ...
        print("See me in pytest output?", te, sep="\n") # observe the error message---reached here
        assert True
    ...
    try:
        ...
        print("See me in pytest output?", te, sep="\n")  # observe the error message
        assert True #do we reach here?--yes because[] cant be used ass it is mutable
...
-zip function ,string.digit function
-dictionaries key should not be mutable..they 
"""
