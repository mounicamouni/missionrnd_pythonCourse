...
def test_for_loop_list_with_enumerate():
    words = ["one", "two", "three"]
    result = []
    for p in enumerate(words):   #enumerate(words,4)----[(4, 'one'), (5, 'two'), (6, 'three')]
        result.append(p)
...
-how to use for loop ,if in pyton
-else in for loop and +for strings,enumerate function
-using while ,for using proper indentation for writing a simple code
"""