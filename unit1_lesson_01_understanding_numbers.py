...
def test_numbers_arithmetic_operations():
    ...
    #>>> import math
    #>>> help(math.isclose)
    assert math.isclose(2.33, 7/3, abs_tol=0.01), "fix abs_tol so that this assert passes"
...
-floor division and modulo operator in python 
-help usage
-int(x,base) usage and x.__int__() usage
"""