...
from module4 import *
s3 = set(dir())
#dir---list of attributes in the module

def test_module_star_import():
    # * imports are not allowed within functions, so we had to do it at global scope
    assert {'m3_func1','m3_func2'} == (s2 - s1)  # what did module3 import bring in.--methods thatdont start with __
    assert {'m4_func1', '_m4_func3'} == (s3 - s2)  # what did module4 import bring in.---only publicly available fns

three_things_i_learnt = """
-importing modules 
-namespace whether local or global in importing modules
-dir function
"""
